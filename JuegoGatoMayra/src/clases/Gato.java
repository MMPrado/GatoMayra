...
public class Gato {
    ...
    public Gato() {  //Define el numero de columnas y filas por medio de este arreglo.
        datos = new int[3][3];
        turnoJ1 = true;
        tiros = 0;
    }
    ...
    public void setBanInicio(boolean bainInicio) {
        this.banInicio = bainInicio;
    }
...
/*
    Le cambiara el turno al otro jugador.
    */
...
/*
    Podremos decir quien es el ganador del juego, definiendo asi quien ocupa las tres casilla con la misma imagen ya sea
...
/*
    Nos permite saber si fue un empate entre los jugadores.
    */
...
/*
    Metodo que nos permitira reiniciar el juego.
    */
